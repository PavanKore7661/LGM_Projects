...
public class Game {
  ...
  private void initialize() {
    frame = new JFrame();
    frame.setForeground(new Color(128, 128, 255));
    frame.setBackground(new Color(255, 255, 255));
    frame.setBounds(100, 100, 654, 523);
    ...
    button1.setForeground(new Color(233, 58, 7));
    ...
    btnReset.setBackground(new Color(189, 225, 198));
    ...
    btnExit.setBackground(new Color(240, 108, 129));
